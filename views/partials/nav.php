            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/" class="<?= urlIs('/') ? 'bg-gray-900 text-white' : '' ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Home</a>
                        ...
                        <a href="/tickets" class=" <?= urlIs('/tickets') ? 'bg-gray-900 text-white' : '' ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Tickets</a>
                        ...
                        <a href="/portfolio" class="<?= urlIs('/portfolio') ? 'bg-gray-900 text-white' : '' ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Portfolio</a>
